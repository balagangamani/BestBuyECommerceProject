...
public class CheckoutPage extends ProjectSpecificationMethod {
	...
	WebElement sryMsgWitOutSignInB4CheckOut;// when using continue sign up at checkout instead of login, also email and
											// number given
	...
	public void enterDetailsOnCheckOut(String debitCardNumber, String expMonthVisibleText, String expYearVisibleText,
			String cvv, String firstName, String lastName, String address, String city, String stateVisibleText,
	...
	public void signInAtCheckOut() {
		type(emailoSignInAtCheckOut, "pavankumar78@gmail.com");
		type(passToSignInAtCheckOut, "Spirit789@");
		clickOn(submitSigInAtCheckOut);
		type(this.emailAtCheckOut, "pavankumar78@gmail.com");
