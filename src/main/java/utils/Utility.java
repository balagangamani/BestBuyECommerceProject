...
public class Utility {
	...
	public static String readProperty(String key) throws Exception {
		String projectPath = System.getProperty("E:\\EclipseClass\\BestBuyECommerceProject\\src\\test\\resources\\");
		File file = new File(
				"E:\\EclipseClass\\BestBuyECommerceProject\\src\\test\\resources\\ConfigBestBuy.properties");
		...
		try (FileInputStream fis = new FileInputStream(new File(excelFilePath));
			...
			for (int i = 0; i < rows; i++) {
				for (int j = 0; j < columns; j++) {
					data[i][j] = sheet.getRow(i).getCell(j).toString(); // Use .toString() to handle cell values of
																		// various types
	...
	public static int screenShot(String testName) throws Exception {
		...
		Thread.sleep(3000);
		String projectPath = System.getProperty("E:\\EclipseClass\\BestBuyECommerceProject");
